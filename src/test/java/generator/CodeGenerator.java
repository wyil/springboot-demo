...
public class CodeGenerator {
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3366/test?useUnicode=true&characterEncoding=utf8&serverTimezone=UTC";
...
//		context.addProperty(PropertyRegistry.CONTEXT_AUTO_DELIMIT_KEYWORDS, "false");
        context.addProperty(PropertyRegistry.CONTEXT_BEGINNING_DELIMITER, delimiterStr);
        context.addProperty(PropertyRegistry.CONTEXT_ENDING_DELIMITER, delimiterStr);
        ...
        pluginConfiguration.setConfigurationType("generator.MapperPlugin");
        pluginConfiguration.addProperty("mappers", ProjectConstant.MAPPER_INTERFACE_REFERENCE);
        context.addPluginConfiguration(pluginConfiguration);

        PluginConfiguration pluginConfiguration2 = new PluginConfiguration();
        pluginConfiguration2.setConfigurationType(ToStringPlugin.class.getCanonicalName());
        context.addPluginConfiguration(pluginConfiguration2);

        PluginConfiguration pluginConfiguration3 = new PluginConfiguration();
        pluginConfiguration3.setConfigurationType(SerializablePlugin.class.getCanonicalName());
...
//		commentGeneratorConfiguration.addProperty(PropertyRegistry.COMMENT_GENERATOR_ADD_REMARK_COMMENTS, "true");
        ...
        commentGeneratorConfiguration.addProperty(PropertyRegistry.CONTEXT_BEGINNING_DELIMITER, delimiterStr);
        commentGeneratorConfiguration.addProperty(PropertyRegistry.CONTEXT_ENDING_DELIMITER, delimiterStr);
        commentGeneratorConfiguration.addProperty("sdd", "sddf");
