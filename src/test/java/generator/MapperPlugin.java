...
public class MapperPlugin extends PluginAdapter {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
        ...
        for (String mapper : this.mappers) {
            ...
            interfaze.addSuperInterface(new FullyQualifiedJavaType(new StringBuilder().append(mapper).append("<")
                    .append(entityType.getShortName()).append(">").toString()));
        }
    ...
    private void processEntityClass(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        if (StringUtility.stringContainsSpace(tableName)) {
            tableName = new StringBuilder().append(this.context.getBeginningDelimiter()).append(tableName)
                    .append(this.context.getEndingDelimiter()).toString();
        }
        ...
        if ((this.caseSensitive) && (!topLevelClass.getType().getShortName().equals(tableName))) {
            ...
            topLevelClass.addAnnotation(new StringBuilder().append("@Table(name = \"")
                    .append(getDelimiterName(tableName)).append("\")").toString());
        }else if ((StringUtility.stringHasValue(this.schema)) || (StringUtility.stringHasValue(this.beginningDelimiter))
