...
/**
 * @ClassName:  JavaAddContentTest   
 * @Description: java追加文件内容测试
 * @author huangruiwen
 * @date   2018年10月15日
 */
...
//            text1("e://text.txt", "123" + new Date().toLocaleString() + "\r\n");
//            text2("e://text.txt", "456" + "\r\n");
//            text3("e://text.txt", "789" + new Date().toLocaleString() + "\r\n");
//	            text4("e://text.txt", "撒范德萨"+"\r\n");
        } catch (Exception e) {
